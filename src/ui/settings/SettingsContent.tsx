// The settings themselves — accounts and general preferences — as native
// grouped lists (the System Settings "Known Networks" pattern): a caption
// above a single rounded container per section, hairline-separated rows
// inside. Each provider is one row; its connect form expands inline beneath
// the row as extra rows in the same container, one open at a time.
//
// Both windows render this: the popover slides it in over the inbox
// (SettingsPane), the main window shows it in place of the split view.
